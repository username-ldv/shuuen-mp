...
public class BASS {
    ...
    public static int BASS_DSP_MONO_N(int n) {
        return n << 24;
    }

    public static int BASS_DSP_STEREO_N(int n) {
        return BASS_DSP_MONO_N(n) | 0x800000;
    }
    ...
    public static native int BASS_MusicLoad(ParcelFileDescriptor file, long offset, int length, int flags, int freq);
