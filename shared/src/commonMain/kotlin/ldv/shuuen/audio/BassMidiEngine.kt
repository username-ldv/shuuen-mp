...
class BassMidiEngine(
    ...
    override fun setPreset(channel: MidiChannel, preset: Preset): Boolean {
        ...
        val bankChanged = Bass.streamEvent(midiStreamHandle, channel.id, Bass.MIDI_EVENT_BANK, preset.bank)
        val programChanged = Bass.streamEvent(midiStreamHandle, channel.id, Bass.MIDI_EVENT_PROGRAM, preset.id)
